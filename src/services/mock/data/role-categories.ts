...
export const roleCategoriesSeed: RoleCategory[] = [
  { id: "rc-decoration", name: "Décoration", slug: "decoration", icon: "Flower2", color: "var(--dore)", sortOrder: 1, primaryReferentId: "p-ref-deco" },
  { id: "rc-boissons", name: "Boissons", slug: "boissons", icon: "GlassWater", color: "var(--bordeaux)", sortOrder: 2, primaryReferentId: "p-ref-boissons" },
  { id: "rc-dj", name: "DJ", slug: "dj", icon: "Music", color: "var(--brun)", sortOrder: 3, primaryReferentId: "p-ref-dj" },
